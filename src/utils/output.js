/**
 * Модуль для кольорового виводу в консоль з емодзі
 * 
 * Надає функції для виводу повідомлень різних типів:
 * - успіх (success)
 * - помилка (error)
 * - інформація (info)
 * - попередження (warning)
 * - заголовок розділу (header)
 * - таблиця (table)
 * 
 * Кожен тип повідомлення має відповідне кольорове форматування та емодзі для покращення UX.
 * 
 * @module utils/output
 */
